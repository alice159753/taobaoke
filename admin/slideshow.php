<?php
    ...
    $myTemplate = new Template(TEMPLATE_DIR ."/slideshow.html");
    ...
    $total_count = $mySlideshow->getCount($condition);
    $total_page = $mySlideshow->getPageCount($page_size, $condition);

    $total_page = ($total_page == 0) ? 1 : $total_page;
    $page = ($total_page < $page) ? $total_page : $page;

    // list
    $rows = $mySlideshow->getPage("*", $page, $page_size, $condition ." ORDER BY ". str_replace("-", " ", $order));
