<?php
    ...
    $myTemplate = new Template(TEMPLATE_DIR ."/product_page.ajax.html");
    ...
    $rows = $myProduct->getPage("*", $page, $page_size, $condition ." ORDER BY rand(), no DESC");
    //$rows = $myProduct->getPage("*", $page, $page_size, $condition ." ORDER BY price ASC, add_time DESC");
